    ...
    <hr class="mt-5">
      ...
      <div class="col-md-8 themed-grid-col p-3">
        <div class=" container bg-light pt-3">
          <span class="fs-4 text-secondary"><strong>Riwayat & Tiket Vaksin</strong></span>

<?php 
$nope = $_SESSION['user']['no_hp'];
 $cekdata=$koneksi->query("SELECT nama_pendaftar,id_pendaftar FROM data_pendaftar WHERE no_hp = '$nope'");
  $hitungcocok = $cekdata->num_rows;

if($hitungcocok==0) :?>

  <h1 align="center">Nomor anda Tidak Terdaftar Vaksinasi</h1>

<?php elseif($hitungcocok >= 1) : ?>
  <?php while($ambildata = $cekdata->fetch_assoc()){ ?>
    <div class="p-3">
    <a href="detail-tiket.php?id=<?php echo($ambildata['id_pendaftar']) ?>" class="link-secondary">
  <div class="card">
  <div class="card-header">
   <p > <b><?php echo strtoupper($ambildata['nama_pendaftar']); ?></b></p>
  </div>
</div>
</a>
</div>
