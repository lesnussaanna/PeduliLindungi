...
$query=$koneksi->query("SELECT * FROM data_pendaftar JOIN vaksinasi ON data_pendaftar.id_pendaftar=vaksinasi.id_pendaftar WHERE data_pendaftar.id_pendaftar = '$id'");
    ...
    if($hitungcocok==0) : ?>
      <div class="alert alert-danger text-center" role="alert">Belum Vaksinasi.</div>
      ...
      while($detail=$query->fetch_assoc()) { ?>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img class="bd-placeholder-img card-img-top" width="100%" height="200" src="assets/img/sertifikat/<?php echo $detail['sertifikat'];?>">
            <div class="card-body">
