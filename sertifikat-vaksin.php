...
<div class="row mb-3 mt-5">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li  class="mb-5">
        <a href="sertifikat-vaksin.php" class="nav-link active">
    ...
    <hr class="mt-5">
      ...
      <div class="col-md-8 themed-grid-col p-3">
        <div class=" container bg-light pt-3">
          <span class="fs-4 text-secondary"><strong>Sertifikat Vaksin</strong></span>
          <?php 
$nope = $_SESSION['user']['no_hp'];
 $cekdata=$koneksi->query("SELECT * FROM data_pendaftar WHERE no_hp = '$nope'");
  $hitungcocok = $cekdata->num_rows;
if($hitungcocok==0) :?>

  <h1 align="center">Nomor Anda Belum Vaksinasi</h1>

<?php elseif($hitungcocok >= 1) : ?>
  <?php  while($cek = $cekdata->fetch_assoc()){ ?>
    <div class="p-3">
    <a href="sertifikat.php?id=<?php echo($cek['id_pendaftar']) ?>" class="link-secondary">
  <div class="card">
  <div class="card-header">
   <p > <b><?php echo strtoupper($cek['nama_pendaftar']); ?></b></p>
  </div>
</div>
</a>
</div>
