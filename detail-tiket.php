...
<html>
<head>
  <title>Riwayat Tiket Vaksin</title>
<?php
include "script.php";
?>
</head>
...
<div class="row mb-3 mt-5">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="riwayat-tiket-vaksin.php" class="nav-link active">
...
<?php 
	...
	$query=$koneksi->query("SELECT * FROM data_pendaftar JOIN vaksinasi ON data_pendaftar.id_pendaftar=vaksinasi.id_pendaftar WHERE data_pendaftar.id_pendaftar = '$id'");
...
<div class="card" style="width: 25rem;">
  <div class="card-body">
    <h5 class="card-title mb-2"> <p class="text-danger"><b>Belum Vaksin</b></p></p></h5>
    <hr>
    <h6 class="card-subtitle text-muted ">Program  Vaksinasi</h6>
    <h6 class="card-subtitle p-3">-</h6>
    <h6 class="card-subtitle text-muted">Lokasi & Jadwal Vaksinasi</h6>
	<h6 class="card-subtitle p-3">-</h6>
</div>
</div>
</div>
...
<?php elseif($hitungcocok >= 1) : ?>
  <?php while($ambildata = $query->fetch_assoc()){ ?>
    <div class="p-3">
<div class="card" style="width: 25rem;">
  <div class="card-body">
    <h5 class="card-title mb-2"> <p class="text-primary"><b><?php echo $ambildata['status_vaksin']; ?></b></p></p></h5>
    <h6 class="card-subtitle mb-2 text-success"><b>Sudah Vaksin</b><br></h6>
    <hr>
    <h6 class="card-subtitle text-muted ">Program  Vaksinasi</h6>
    <?php
    $ambil = $koneksi->query("SELECT * FROM jadwal_vaksinasi WHERE id_jadwal='$ambildata[id_jadwal]'");
    $program=$ambil->fetch_assoc()
    ?>
    <h6 class="card-subtitle p-3"><?php echo $program['program']; ?></h6>
    <h6 class="card-subtitle text-muted">Lokasi & Jadwal Vaksinasi</h6>
	<h6 class="card-subtitle p-3"><?php echo $program['lokasi']; ?></h6>
</div>
</div>
</div>
<?php } ?>
