    ...
    <hr class="mt-5">
      ...
      <div class="col-md-8 themed-grid-col">
      	<div class=" container bg-light pt-3">
      		<span class="fs-4 ps-2"><strong>Profil</strong></span>
           <span class="fe-4" style="padding-left: 28rem;"> <a href="perbarui-profil.php" class="btn btn-outline-primary"><b>Perbarui Profil</b></a></span>
           <hr>
           <div class="p-3">
           <ul class="navbar-nav">
            <li class="pb-1"><dl>
              <dt>Identitas Akun</dt>
              <dd><span><?php echo $_SESSION['user']['status_kewarganegaran']; ?></span></dd>
            </dl></li>
            <li class="pb-1"><dl>
              <dt>Nama Lengkap</dt>
              <dd><span><?php echo $_SESSION['user']['nama_lengkap']; ?></span></dd>
            </dl></li>
              <li class="pb-1"><dl>
                <dt>NIK</dt>
                <dd><span><?php echo $_SESSION['user']['no_pengenal']; ?></span></dd>
              </dl></li>
              <li class="pb-1"><dl>
                <dt>Nomor Ponsel</dt>
                <dd><span><?php echo $_SESSION['user']['no_hp']; ?></span></dd>
              </dl></li>
              <li class="pb-1"><dl>
                <dt>Email</dt>
                <dd><span><?php echo $_SESSION['user']['email']; ?></span></dd>
              </dl></li>
              <li class="pb-1"><dl>
                <dt>Tanggal Lahir</dt>
                <dd><span><?php echo $_SESSION['user']['tanggal_lahir']; ?></span></dd>
              </dl></li>
            </ul>
        </div>
      	</div>
